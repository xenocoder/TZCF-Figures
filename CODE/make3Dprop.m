...
% First 2009 divinyl chl-a (prochlococcus)
clf
clear c c2 h h2 t v v2 x1 x2 y1 y2 z1 z2
subplot(2,1,1)
x1 = TC9805.latitude(1,:);
y1 = TC9805.pressure(1:40)';
t = TC9805.potentialdensity(1:40,:); 
t(find(t==0)) = NaN;
...
subplot(2,1,2)
clear c c2 h h2 t v v2 x1 x2 y1 y2 z1 z2
%now 2011 divinyl chl-a (prochlorococcus)
x1 = SE1102.HPLC.latitude(1,:);
y1 = SE1102.HPLC.pressure(1:10)';
t = SE1102.HPLC.pigrats.chlapro./1000; %in mg m-3
t(find(t==0)) = NaN;
z1 = inpaint_nans(t,1); %interpolate missing values
z1(find(z1<0))=0; %setr all negative extrapolations to 0
