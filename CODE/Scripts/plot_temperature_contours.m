...
y2 = 5:0.5:200;
y2 = y2';
z1 = TC9704.temperature(1:100,1:33);
...
title (horzcat('Temperature (\circC) along 172\circW, ',sday,'-',eday));
...
y2 = 5:0.5:200;
y2 = y2';
z1 = TC9805.temperature(1:41,1:29);
z2 = interp2(x1,y1,z1,x2,y2,'cubic');
...
title (horzcat('Temperature (\circC) along 172\circW, ','04/26/98','-','04/30/98'));
clabel(c,h,'color','w') %make labels white
...
y2 = 5:0.5:200;
y2 = y2';
z1 = TC9905.temperature(1:200,1:42);
z2 = interp2(x1,y1,z1,x2,y2,'cubic');
...
y2 = 5:0.5:200;
y2 = y2';
z1 = TC0004.temperature(1:100,1:34);
z2 = interp2(x1,y1,z1,x2,y2,'cubic');
...
y2 = 5:0.5:200;
y2 = y2';
z1 = SE1102.temperature(1:200,1:41);
z2 = interp2(x1,y1,z1,x2,y2,'cubic');
