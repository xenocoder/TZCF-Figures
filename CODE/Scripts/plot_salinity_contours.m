...
title (horzcat('Salinity (PSU) along 172\circW, ',sday,'-',eday));
...
title (horzcat('Salinity (PSU) along 172\circW, ','04/26/98','-','04/30/98'));
clabel(c,h,'color','w') %make labels white
