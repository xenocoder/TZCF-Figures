...
proc(1,1) = sum(procspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;%spline freaks out at lower levels but no real signal
prok(1,1) = sum(prokspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
galgae(1,1) = sum(galgaespline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
crypto(1,1) = sum(cryptospline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
pelago(1,1) = sum(pelagospline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
prym(1,1) = sum(prymspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
dino(1,1) = sum(dinospline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
diat(1,1) = sum(diatspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
picopl(1,1) = sum(picoplspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
nanopl(1,1) = sum(nanoplspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
micropl(1,1) = sum(microplspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
...
proc(1,2) = sum(procspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;%spline freaks out at lower levels but no real signal
prok(1,2) = sum(prokspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
galgae(1,2) = sum(galgaespline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
crypto(1,2) = sum(cryptospline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
pelago(1,2) = sum(pelagospline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
prym(1,2) = sum(prymspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
dino(1,2) = sum(dinospline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
diat(1,2) = sum(diatspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
picopl(1,2) = sum(picoplspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
nanopl(1,2) = sum(nanoplspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
micropl(1,2) = sum(microplspline(1,1:150))./sum(SDPspline(1,1:150)).*sum(totalspline(1,1:150))./1000;
...
proc(3,1) = sum(procspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;%spline freaks out at lower levels but no real signal
prok(3,1) = sum(prokspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
galgae(3,1) = sum(galgaespline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
crypto(3,1) = sum(cryptospline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
pelago(3,1) = sum(pelagospline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
prym(3,1) = sum(prymspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
dino(3,1) = sum(dinospline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
diat(3,1) = sum(diatspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
picopl(3,1) = sum(picoplspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
nanopl(3,1) = sum(nanoplspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
micropl(3,1) = sum(microplspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
...
proc(3,2) = sum(procspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;%spline freaks out at lower levels but no real signal
prok(3,2) = sum(prokspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
galgae(3,2) = sum(galgaespline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
crypto(3,2) = sum(cryptospline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
pelago(3,2) = sum(pelagospline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
prym(3,2) = sum(prymspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
dino(3,2) = sum(dinospline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
diat(3,2) = sum(diatspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
picopl(3,2) = sum(picoplspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
nanopl(3,2) = sum(nanoplspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
micropl(3,2) = sum(microplspline(1,1:160))./sum(SDPspline(1,1:160)).*sum(totalspline(1,1:160))./1000;
