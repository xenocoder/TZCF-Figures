...
#Change 1,2,3 to '1-STG','2-STFZ','3-TZCF' since Matlab only writes numbers
pig$zone[pig$zone==1]='1-STG'
pig$zone[pig$zone==2]='2-STFZ'
pig$zone[pig$zone==3]='3-TZCF'
...
# Barplot of all groups in all areas grouped by year and zone (NOT USED)
