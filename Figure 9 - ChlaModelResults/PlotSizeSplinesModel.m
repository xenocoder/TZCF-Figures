...
[~, picoplmodelspline] = calcspline(SE0802.HPLC.hirata.MODEL.picoplmodel, x, XI, ssta, esta);
[~, nanoplmodelspline] = calcspline(SE0802.HPLC.hirata.MODEL.nanoplmodel, x, XI, ssta, esta);
[~, microplmodelspline] = calcspline(SE0802.HPLC.hirata.MODEL.microplmodel, x, XI, ssta, esta);
...
picoplmodelspline(1,150:175) = 0; %spline freaks out at lower levels but no real signal
nanoplmodelspline(1,150:175) = 0; %spline freaks out at lower levels but no real signal
microplmodelspline(1,150:175) = 0; %spline freaks out at lower levels but no real signal

clf
subplot(2,3,1)
plot(picoplspline./SDPspline, XI,'bo','LineWidth',3)
axis ij
set(gca, 'XLim', [0 1])
hold on
plot(nanoplspline./SDPspline, XI,'go','LineWidth',3)
plot(microplspline./SDPspline, XI,'ro','LineWidth',3)

plot(picoplmodelspline, XI,'b-','LineWidth',3)
plot(nanoplmodelspline, XI,'g-','LineWidth',3)
plot(microplmodelspline, XI,'r-','LineWidth',3)
