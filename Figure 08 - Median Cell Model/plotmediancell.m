...
a = csvread('chlpigdatahirata-surface.csv',1); %Linked data file gotten from integration of Hirata model
...
md50array(6,1) = mean(md5011(33:43,2)); %2011 TZCF (33.25-34.25)
%md50array(6,1) = mean(md5011(26:36,2)); %2011 TZCF (32.50-33.50) OLD!!!
