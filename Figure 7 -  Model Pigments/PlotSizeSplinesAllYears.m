...
clf
subplot(2,3,1)
plot(picoplspline.*totalspline./1000, XI,'b-','LineWidth',3)
axis ij
set(gca, 'XLim', [0 0.5])
hold on
plot(nanoplspline.*totalspline./1000, XI,'g-','LineWidth',3)
plot(microplspline.*totalspline./1000, XI,'r-','LineWidth',3)
...
[~, picoplspline] = calcspline(SE0802.HPLC.hirata.proc, x, XI, ssta, esta);
[~, nanoplspline] = calcspline(SE0802.HPLC.hirata.prok, x, XI, ssta, esta);
[~, microplspline] = calcspline(SE0802.HPLC.hirata.prym, x, XI, ssta, esta);
...
subplot(2,3,4)
plot(picoplspline./1000, XI,'b-','LineWidth',3)
axis ij
set(gca, 'XLim', [0 0.5])
hold on
plot(microplspline./1000, XI,'g-','LineWidth',3)
plot(nanoplspline./1000, XI,'r-','LineWidth',3)
...
[~, picoplspline] = calcspline(SE0902.HPLC.hirata.proc, x, XI, ssta, esta);
[~, nanoplspline] = calcspline(SE0902.HPLC.hirata.prok, x, XI, ssta, esta);
[~, microplspline] = calcspline(SE0902.HPLC.hirata.prym, x, XI, ssta, esta);
...
[~, picoplspline] = calcspline(SE1102.HPLC.hirata.proc, x, XI, ssta, esta);
[~, nanoplspline] = calcspline(SE1102.HPLC.hirata.prok, x, XI, ssta, esta);
[~, microplspline] = calcspline(SE1102.HPLC.hirata.prym, x, XI, ssta, esta);
