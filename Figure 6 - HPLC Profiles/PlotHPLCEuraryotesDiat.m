...
% fuco low light conditions characteristic of the deeper euphotic zone
% waters

%Here taking divinyl-chlorophyll-a as prochlorococcus and
% Fucoxanthin (Pelago) as synechoccus (prokaryotic phytoplankton)
...
x = nanmean(SE0802.HPLC.fuco(:,ssta:esta),2);
...
legend('2008','2009','2011','Location','northeast')
title('Mean Fucoxanthin (Diat) at STFZ')
xlabel('Fucoxanthin (nmol kg-1)')
ylabel('Pressure (db)')
...
legend('2008','2009','2011','Location','northeast')
title('Mean Fucoxanthin (Diat) at TZCF')
xlabel('Fucoxanthin (nmol kg-1)')
ylabel('Pressure (db)')