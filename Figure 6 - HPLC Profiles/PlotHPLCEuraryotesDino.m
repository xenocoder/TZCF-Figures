...
% per low light conditions characteristic of the deeper euphotic zone
% waters

%Here taking divinyl-chlorophyll-a as prochlorococcus and
% Peridinin (Pelago) as synechoccus (prokaryotic phytoplankton)
...
title('Mean Peridinin (Dino) at STFZ')
...
legend('2008','2009','2011','Location','northeast')
title('Mean Peridinin (Dino) at TZCF')
xlabel('Peridinin (nmol kg-1)')
ylabel('Pressure (db)')