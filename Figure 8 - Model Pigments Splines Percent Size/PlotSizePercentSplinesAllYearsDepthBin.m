...
clf
subplot(2,3,1)
plot(picoplspline./SDPspline, XI,'b-','LineWidth',3)
axis ij
set(gca, 'XLim', [0 1], 'YLim', [0 150])
hold on
plot(nanoplspline./SDPspline, XI,'g-','LineWidth',3)
plot(microplspline./SDPspline, XI,'r-','LineWidth',3)
