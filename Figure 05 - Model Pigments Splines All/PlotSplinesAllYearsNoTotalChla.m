...
%deal with missing values at 100,125m.
prokspline = interphplc08(SE0802.HPLC.hirata.prok(:,ssta:esta),x,1:200);
galgaespline = interphplc08(SE0802.HPLC.hirata.galgae(:,ssta:esta),x,1:200);
cryptospline = interphplc08(SE0802.HPLC.hirata.crypto(:,ssta:esta),x,1:200);
pelagospline = interphplc08(SE0802.HPLC.hirata.pelago(:,ssta:esta),x,1:200);
prymspline = interphplc08(SE0802.HPLC.hirata.prym(:,ssta:esta),x,1:200);
dinospline = interphplc08(SE0802.HPLC.hirata.dino(:,ssta:esta),x,1:200);
diatspline = interphplc08(SE0802.HPLC.hirata.diatoms(:,ssta:esta),x,1:200);
...
clf
subplot(2,3,1)
plot(prokspline(1:175)./SDPspline(1:175).*totalspline(1:175)./1000, XI(1:175),'b-','LineWidth',3)
axis ij
set(gca, 'XLim', [0 0.3], 'YLim', [0 180])
hold on
plot(galgaespline(1:175)./SDPspline(1:175).*totalspline(1:175)./1000, XI(1:175),'g-','LineWidth',3)
%plot(cryptospline(1:175)./SDPspline(1:175).*totalspline(1:175)./1000, XI(1:175),'c--','LineWidth',3)
plot(pelagospline(1:175)./SDPspline(1:175).*totalspline(1:175)./1000, XI(1:175),'r-','LineWidth',3)
plot(prymspline(1:175)./SDPspline(1:175).*totalspline(1:175)./1000, XI(1:175),'m-','LineWidth',3)
plot(dinospline(1:175)./SDPspline(1:175).*totalspline(1:175)./1000, XI(1:175),'c-','LineWidth',3)
plot(diatspline(1:175)./SDPspline(1:175).*totalspline(1:175)./1000, XI(1:175),'r--','LineWidth',3)
%plot(totalspline(1:175)./1000, XI,'k--','LineWidth',3)

title('Phytoplankton Composition at STFZ in 2008')
xlabel('Chl-a (mg m-3)')
ylabel('Pressure (db)')
%legend('Location','southeast', 'Prokaryotes','Green Algae','Cryptophytes','Pelagophytes', 'Prymnesio','Dinoflag','Diatoms')
...
% prokspline(1,160:200) = 0; %spline freaks out at lower levels but no real signal
% galgaespline(1,160:200) = 0; %spline freaks out at lower levels but no real signal
% cryptospline(1,160:200) = 0; %spline freaks out at lower levels but no real signal
% pelagospline(1,160:200) = 0; %spline freaks out at lower levels but no real signal
% %prymspline(1,150:175) = 0; %spline freaks out at lower levels but no real signal
% dinospline(1,160:200) = 0; %spline freaks out at lower levels but no real signal
% diatspline(1,160:200) = 0; %spline freaks out at lower levels but no real signal
...
ylabel('Pressure (db)')
%legend('Location','southeast', 'Prokaryotes','Green Algae','Cryptophytes','Pelagophytes', 'Prymnesio','Dinoflag','Diatoms')
legend('Location','southeast', 'Prokaryotes','Green Algae','Pelagophytes', 'Prymnesio','Dinoflag','Diatoms')